...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StudentListScreen_noasistio(),
    );
  }
}

class StudentListScreen_noasistio extends StatelessWidget {
  const StudentListScreen_noasistio({Key? key}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color.fromARGB(255, 192, 79, 107),
